 ...
 * @author chags
 */
public class excluir_disc extends HttpServlet {
        ...
        processRequest(request, response);
         ...
         try {
           ...
           Disciplina f=new Disciplina();
            f.setIdDisc(Integer.parseInt(request.getParameter("id")));
            fun.excluir(f);
            request.getRequestDispatcher("cad_disc.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        processRequest(request, response);
          ...
          try {  
            ...
            DisciplinaDAO cf =new DisciplinaDAO();
            
            fun.setNome(request.getParameter("disc"));
            fun.setAno(Integer.parseInt(request.getParameter("ano")));
            fun.setIdDisc(Integer.parseInt(request.getParameter("id")));
            fun.setidCurso(cf.cursoidano(request.getParameter("curso"),fun));
            
             
            cf.alterar(fun);
            request.getRequestDispatcher("edit_disc.jsp").forward(request, response);
