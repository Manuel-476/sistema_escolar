 ...
 * @author chags
 */
public class excluir_estudan extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        processRequest(request, response);
            ...
            f.setIdAluno(Integer.parseInt(request.getParameter("id")));
            fun.excluir(f);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {  
            Estudante fun=new Estudante();  
            EstudanteDAO cf =new EstudanteDAO();
            
            fun.setTurma(request.getParameter("turma"));
            ...
            fun.setIdturma(cf.turmaid(request.getParameter("turma")));
            fun.setIdAluno(Integer.parseInt(request.getParameter("id")));
