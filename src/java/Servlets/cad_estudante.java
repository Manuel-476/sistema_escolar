 ...
 * @author chags
 */
public class cad_estudante extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        processRequest(request, response);
         try {  
           ...
           EstudanteDAO est=new EstudanteDAO();
           
            fun.setTurno(request.getParameter("turno"));
            fun.setIdturma(est.turmaid(request.getParameter("turma").toString()));
            ...
            response.sendRedirect("cad_estudante.jsp");
